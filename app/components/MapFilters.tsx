        ...
        <button
          ...
          className={`px-4 py-2 rounded-full font-sans text-sm font-medium transition-all ${
            active === filter.value
              ...
              : 'bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-stone-100 dark:hover:bg-slate-700 border border-stone-200 dark:border-stone-600'
          }`}
        >
